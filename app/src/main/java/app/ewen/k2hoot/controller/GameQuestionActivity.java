        ...
        for (int i = 0; i < mButtons.size(); i++) {
            if (mButtons.get(i) == v) {
                ...
                if (mQuestionStep.isGoodAnswer(userInput)) {
                    isGoodAnswer = true;
                    Toast.makeText(this, getString(R.string.GameQuestionActivity_Success_Toast), Toast.LENGTH_SHORT).show();
                } else {
                    isGoodAnswer = false;
                    Toast.makeText(this, getString(R.string.GameQuestionActivity_Error_Toast), Toast.LENGTH_SHORT).show();
                }
                break;
            }
        }
